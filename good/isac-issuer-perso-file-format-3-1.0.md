...
|---------|--------------------|---------------------------------------------------------------------------------|
| 1.0.2   | July 15, 2022      | <!-- mij --> `CARDSUM` order changed and moved after the `PRODUCT`              |
| 1.0.1   | September 17, 2021 | <!-- ld --> `PRODUCT / RECORD / CARRIER / LANG` length changed from [2-3] to 2. |
| 1.0.0   | January 18, 2021   | <!-- mka --> Initial version of card printer format specification.              |
